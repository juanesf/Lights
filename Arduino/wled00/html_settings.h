...
<h3>diyHue Setup</h3>
Virtual Lights to Emulate: <input name="DLC" type="number" min="1" max="10" required><br>
Transitions Leds: <input name="DLT" type="number" min="0" max="10" required><br>
Pixel by Virtual Lights: <input name="DLLC" type="number" <br>
<button type="button" onclick="B()">Back</button><button type="submit">Save</button>
</form>
</body>
</html>)=====";
